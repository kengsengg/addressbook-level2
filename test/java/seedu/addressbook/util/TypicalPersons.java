...
public class TypicalPersons {
    ...
    public TypicalPersons() {
        try {
            amy = new Person(new Name("Amy Buck"), new DateOfBirth("01231995", true), new Phone("91119111", false), new Email("ab@gmail.com", false),
                    new Address("1 Clementi Road", false), new UniqueTagList());
            bill = new Person(new Name("Bill Clint"), new DateOfBirth("01011960", false), new Phone("92229222", false), new Email("bc@gmail.com", false),
                    new Address("2 Clementi Road", true), new UniqueTagList());
            candy = new Person(new Name("Candy Destiny"), new DateOfBirth("03021975", false), new Phone("93339333", true),
                    new Email("cd@gmail.com", false), new Address("3 Clementi Road", true), new UniqueTagList());
            dan = new Person(new Name("Dan Smith"), new DateOfBirth("11091980", true), new Phone("1234556", true), new Email("ss@tt.com", true),
