...
* Support for storing address (`a/`), date of birth (`d/`) and tags (`t/`)
* Support for marking a contact detail as 'private' (`pa/`) (`pd/`) (`pe/`) (`pp/`)
...
Format: `add NAME [p]d/DATE OF BIRTH [p]p/PHONE_NUMBER [p]e/EMAIL [p]a/ADDRESS [t/TAG]...`
...
Examples: 
* `add John Doe d/01231995 p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01`
* `add Betsy Crowe pd/12011970 pp/1234567 e/betsycrowe@gmail.com pa/Newgate Prison t/criminal t/friend`
